...
export default function DashboardClient({ tournaments }: Props) {
  ...
  async function handleCreateSample() {
    ...
    // 32人を8卓に割り振り × 8ラウンド
    // 各卓合計 = 100000、スコアにバリエーション（同点・トビ・接戦あり）
    const rounds1: { r: number; t: number; pi: number[]; sc: number[] }[] = [
      // R1
      { r:1, t:1, pi:[0,1,2,3],     sc:[45200,28300,17500,9000] },
      { r:1, t:2, pi:[4,5,6,7],     sc:[33100,27900,22000,17000] },
      { r:1, t:3, pi:[8,9,10,11],   sc:[38000,30000,22000,10000] },
      { r:1, t:4, pi:[12,13,14,15], sc:[41500,25500,18000,15000] },
      { r:1, t:5, pi:[16,17,18,19], sc:[29000,29000,25000,17000] },
      { r:1, t:6, pi:[20,21,22,23], sc:[36800,26200,21000,16000] },
      { r:1, t:7, pi:[24,25,26,27], sc:[50100,24900,15000,10000] },
      { r:1, t:8, pi:[28,29,30,31], sc:[32000,28000,22000,18000] },
      // R2
      { r:2, t:1, pi:[0,5,10,15],   sc:[31000,31000,23000,15000] },
      { r:2, t:2, pi:[1,4,11,14],   sc:[42300,26700,18000,13000] },
      { r:2, t:3, pi:[2,7,8,13],    sc:[35000,28000,21500,15500] },
      { r:2, t:4, pi:[3,6,9,12],    sc:[28000,27000,25000,20000] },
      { r:2, t:5, pi:[16,21,26,31], sc:[39500,25500,20000,15000] },
      { r:2, t:6, pi:[17,20,27,30], sc:[33000,29000,22000,16000] },
      { r:2, t:7, pi:[18,23,24,29], sc:[46000,22000,18000,14000] },
      { r:2, t:8, pi:[19,22,25,28], sc:[30000,30000,25000,15000] },
      // R3
      { r:3, t:1, pi:[0,7,9,14],    sc:[37500,26500,21000,15000] },
      { r:3, t:2, pi:[1,6,8,15],    sc:[25000,25000,25000,25000] },
      { r:3, t:3, pi:[2,5,11,12],   sc:[43200,24800,19000,13000] },
      { r:3, t:4, pi:[3,4,10,13],   sc:[34000,30000,22000,14000] },
      { r:3, t:5, pi:[16,23,25,30], sc:[28500,28500,22000,21000] },
      { r:3, t:6, pi:[17,22,24,31], sc:[40000,27000,19000,14000] },
      { r:3, t:7, pi:[18,21,27,28], sc:[32000,28000,24000,16000] },
      { r:3, t:8, pi:[19,20,26,29], sc:[36000,26000,20000,18000] },
      // R4
      { r:4, t:1, pi:[0,6,11,13],   sc:[28000,28000,28000,16000] },
      { r:4, t:2, pi:[1,7,10,12],   sc:[38500,27500,20000,14000] },
      { r:4, t:3, pi:[2,4,9,15],    sc:[25000,25000,25000,25000] },
      { r:4, t:4, pi:[3,5,8,14],    sc:[44000,24000,18000,14000] },
      { r:4, t:5, pi:[16,22,27,29], sc:[35000,28000,21000,16000] },
      { r:4, t:6, pi:[17,23,26,28], sc:[31000,29000,23000,17000] },
      { r:4, t:7, pi:[18,20,25,31], sc:[42500,25500,19000,13000] },
      { r:4, t:8, pi:[19,21,24,30], sc:[29000,27000,24000,20000] },
      // R5
      { r:5, t:1, pi:[0,4,8,12],    sc:[39000,26000,20000,15000] },
      { r:5, t:2, pi:[1,5,9,13],    sc:[33500,28500,22000,16000] },
      { r:5, t:3, pi:[2,6,10,14],   sc:[27000,27000,27000,19000] },
      { r:5, t:4, pi:[3,7,11,15],   sc:[47000,23000,17000,13000] },
      { r:5, t:5, pi:[16,20,24,28], sc:[30000,30000,22000,18000] },
      { r:5, t:6, pi:[17,21,25,29], sc:[36500,25500,21000,17000] },
      { r:5, t:7, pi:[18,22,26,30], sc:[41000,28000,18000,13000] },
      { r:5, t:8, pi:[19,23,27,31], sc:[25000,25000,25000,25000] },
      // R6
      { r:6, t:1, pi:[0,13,22,31],  sc:[32000,29000,23000,16000] },
      { r:6, t:2, pi:[1,12,23,30],  sc:[44500,24500,18000,13000] },
      { r:6, t:3, pi:[2,15,20,29],  sc:[28000,28000,25000,19000] },
      { r:6, t:4, pi:[3,14,21,28],  sc:[37000,27000,21000,15000] },
      { r:6, t:5, pi:[4,9,18,27],   sc:[35500,26500,22000,16000] },
      { r:6, t:6, pi:[5,8,19,26],   sc:[40000,25000,20000,15000] },
      { r:6, t:7, pi:[6,11,16,25],  sc:[29000,28000,24000,19000] },
      { r:6, t:8, pi:[7,10,17,24],  sc:[43000,27000,18000,12000] },
      // R7
      { r:7, t:1, pi:[0,14,19,28],  sc:[26000,26000,26000,22000] },
      { r:7, t:2, pi:[1,15,18,29],  sc:[36000,28000,22000,14000] },
      { r:7, t:3, pi:[2,12,17,30],  sc:[41500,26500,19000,13000] },
      { r:7, t:4, pi:[3,13,16,31],  sc:[30000,30000,24000,16000] },
      { r:7, t:5, pi:[4,10,23,26],  sc:[38000,25000,20000,17000] },
      { r:7, t:6, pi:[5,11,22,27],  sc:[33000,28000,23000,16000] },
      { r:7, t:7, pi:[6,8,21,24],   sc:[45000,23000,18000,14000] },
      { r:7, t:8, pi:[7,9,20,25],   sc:[28500,28500,24000,19000] },
      // R8
      { r:8, t:1, pi:[0,11,17,26],  sc:[34000,28000,22000,16000] },
      { r:8, t:2, pi:[1,10,16,27],  sc:[39500,25500,20000,15000] },
      { r:8, t:3, pi:[2,9,19,24],   sc:[30000,30000,23000,17000] },
      { r:8, t:4, pi:[3,8,18,25],   sc:[42000,26000,18000,14000] },
      { r:8, t:5, pi:[4,15,21,30],  sc:[27000,27000,27000,19000] },
      { r:8, t:6, pi:[5,14,20,31],  sc:[37500,26500,21000,15000] },
      { r:8, t:7, pi:[6,13,23,28],  sc:[33000,29000,22000,16000] },
      { r:8, t:8, pi:[7,12,22,29],  sc:[46000,24000,17000,13000] },
    ]

  ...
  return (
    <button
      ...
      style={{
        ...
        background: 'var(--hamburger-bg, var(--navy))',
        border: '1px solid var(--hamburger-border, rgba(0,240,255,0.35))',
        borderRadius: '12px',
        color: 'var(--hamburger-color, #00f0ff)',
        fontSize: '22px',
        cursor: 'grab',
        touchAction: 'none',
        boxShadow: 'var(--hamburger-shadow, 0 2px 16px rgba(0,240,255,0.25), 0 2px 12px rgba(0,0,0,0.4))',
        userSelect: 'none',

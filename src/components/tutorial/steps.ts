...
export const scheduleSteps: TutorialStep[] = [
  ...
  { target: '[data-tutorial="table-card"]', content: '各卓の点数を入力します。参加者がQRコードから入力した点数もここに反映されます。プレイヤーをドラッグ＆ドロップで入れ替えることもできます。', placement: 'bottom' },
...
export const playerSteps: TutorialStep[] = [
  { target: '[data-tutorial="player-score-input"]', content: 'ここから自分の卓の点数を入力して送信できます。席が固定でなければ，卓内でプレイヤーを入れ替えできます。', placement: 'bottom' },
